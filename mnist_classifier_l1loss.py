...
# model
class MnistClassifierL1Loss(nn.Module):
    def __init__(self):
        super().__init__()
...
def mnist_classifier_l1loss():
    ...
    # model
    model = MnistClassifierL1Loss().to(device)
    ...
    for epoch in epochs:
        ...
        # epoch state
        state_file_name = 'mnist_classifier_l1loss_epoch_{epoch_index}.pkl'.format(epoch_index=epoch)
        save_state(model=model, directory=path['state'], file_name=state_file_name)

    # train loss
    save_data(array=train_losses, directory=path['array'],
              file_name='mnist_classifier_l1loss_train_loss.npy')
    draw_line_graph(x=epochs, y=train_losses,
                    x_label='Epoch', y_label='Loss',
                    title='Mnist Classifier L1Loss Train Loss',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_train_loss.png')

    # train accuracy
    save_data(array=train_accuracies, directory=path['array'],
              file_name='mnist_classifier_l1loss_train_accuracy.npy')
    draw_line_graph(x=epochs, y=train_accuracies,
                    x_label='Epoch', y_label='Accuracy',
                    title='Mnist Classifier L1Loss Train Accuracy',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_train_accuracy.png')

    # validation loss
    save_data(array=validation_losses, directory=path['array'],
              file_name='mnist_classifier_l1loss_validation_loss.npy')
    draw_line_graph(x=epochs, y=validation_losses,
                    x_label='Epoch', y_label='Loss',
                    title='Mnist Classifier L1Loss Validation Loss',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_validation_loss.png')

    # validation accuracy
    save_data(array=validation_accuracies, directory=path['array'],
              file_name='mnist_classifier_l1loss_validation_accuracy.npy')
    draw_line_graph(x=epochs, y=validation_accuracies,
                    x_label='Epoch', y_label='Accuracy',
                    title='Mnist Classifier L1Loss Validation Accuracy',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_validation_accuracy.png')

    # test loss
    save_data(array=test_losses, directory=path['array'],
              file_name='mnist_classifier_l1loss_test_loss.npy')
    draw_line_graph(x=epochs, y=test_losses,
                    x_label='Epoch', y_label='Loss',
                    title='Mnist Classifier L1Loss Test Loss',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_test_loss.png')

    # test accuracy
    save_data(array=test_accuracies, directory=path['array'],
              file_name='mnist_classifier_l1loss_test_accuracy.npy')
    draw_line_graph(x=epochs, y=test_accuracies,
                    x_label='Epoch', y_label='Accuracy',
                    title='Mnist Classifier L1Loss Test Accuracy',
                    directory=path['graph'],
                    file_name='mnist_classifier_l1loss_test_accuracy.png')
    ...
    draw_multi_lines_graph(
        ...
        x_label='Epoch', y_label='Loss',
        title='Mnist Classifier L1Loss Loss',
        directory=path['graph'],
        file_name='mnist_classifier_l1loss_loss.png')
    ...
    draw_multi_lines_graph(
        ...
        x_label='Epoch', y_label='Accuracy',
        title='Mnist Classifier L1Loss Accuracy',
        directory=path['graph'],
        file_name='mnist_classifier_l1loss_accuracy.png')


# main
if __name__ == '__main__':
    mnist_classifier_l1loss()
